...
weights_lits=[
               ...
               # 'checkpoint/TSM_mmvpr_RTD_resnet50_shift8_blockres_avg_segment8_e32_best/ckpt_25.pth.tar',
               'checkpoint/TSM_mmvpr_RTD_resnet101_shift8_blockres_avg_segment8_e30_best/ckpt_27.pth.tar',
               # 'checkpoint/TSM_mmvpr_RTD_mobilenetv2_shift8_blockres_avg_segment8_e31/ckpt_best.pth.tar'
               # 'checkpoint/TSM_mmvpr_RTD_resnet101_shift8_blockres_avg_segment8_e31_s1/ckpt_best.pth.tar'
...
# args.weights= weights_lits[2]
# is_shift, shift_div, shift_place = parse_shift_option_from_log_name(args.weights)
# this_arch = args.weights.split('TSM_')[1].split('_')[2]
# net3 = TSN(num_class, args.test_segments if is_shift else 1, args.modality,
#           base_model=this_arch,
#           consensus_type=args.crop_fusion_type,
#           img_feature_dim=args.img_feature_dim,
#           pretrain=args.pretrain,
...
# net3.load_state_dict(base_dict)
# net3.eval()
# net_list.append(net3)
...
cropping = torchvision.transforms.Compose([
    ...
    # GroupWindowCrop(input_size, 224, 4)
])
...
def eval_video(video_data, net_list, this_test_segments):
    with torch.no_grad():
        ...
        num_crop = args.test_crops # args.test_crops
        ...
        data_in = data[0].view(batch_size, -1, data.size(2), data.size(3))
