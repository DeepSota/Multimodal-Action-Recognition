...
ROOT_DATASET = '/data2/wsp/multi-modal-tsm/ICPR_MMVPR_Track3/'  # '/data/jilin/'

def return_mmvpr(modality):
    filename_categories = 20
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'training_set/rgb_data'
        filename_imglist_train = ROOT_DATASET + "training_set/train_videofolder.txt"
        filename_imglist_val = ROOT_DATASET + "training_set/val_videofolder.txt"
        prefix = '{:06d}.jpg'
    elif modality == 'IR':
        root_data = ROOT_DATASET + 'training_set/ir_data'
        filename_imglist_train = ROOT_DATASET + "training_set/train_videofolder.txt"
        filename_imglist_val = ROOT_DATASET + "training_set/val_videofolder.txt"
        prefix = '{:06d}.jpg'
    elif modality == 'Depth':
        root_data = ROOT_DATASET + 'training_set/depth_data'
        filename_imglist_train = ROOT_DATASET + "training_set/train_videofolder.txt"
        filename_imglist_val = ROOT_DATASET + "training_set/val_videofolder.txt"
        prefix = '{:06d}.png'
    elif modality == 'RTD':
        root_data_rgb =ROOT_DATASET + 'training_set/rgb_data'
    ...
    if modality!='RTD':
        ...
        return filename_categories, filename_imglist_train, filename_imglist_val, root_data_rgb, root_data_depth,root_data_ir, prefix_rgb,prefix_ir,prefix_depth
...
def return_dataset(dataset, modality):
    ...
    dict_multi = {"mmvpr" :return_mmvpr}

    if dataset in dict_single:
        file_categories, file_imglist_train, file_imglist_val, root_data, prefix = dict_single[dataset](modality)
    elif dataset in dict_multi:
        file_categories, file_imglist_train, file_imglist_val, root_data_rgb, root_data_depth, root_data_ir, prefix_rgb, prefix_ir, prefix_depth = dict_multi[dataset](modality)
    else:
    ...
    if dataset in dict_multi:
        return n_class, file_imglist_train, file_imglist_val, root_data_rgb, root_data_depth, root_data_ir, prefix_rgb, prefix_ir, prefix_depth
    else:
